        ...
        if ($request->isXmlHttpRequest() && $request->isPost() && $requestData) {
            foreach ($requestData as $itemData) {
                try {
                    ...
                    $source = $this->placeRepository->getById($placeId);
                    $this->dataObjectHelper->populateWithArray($source, $itemData, PlaceInterface::class);
                    $this->placeRepository->save($source);
