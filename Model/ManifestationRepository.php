...
class ManifestationRepository implements ManifestationRepositoryInterface
{
     ...
     * @inheritdoc
     */
    public function getList(SearchCriteriaInterface $searchCriteria = null): ManifestationSearchResultsInterface
    {
        ...
        /** @var ManifestationSearchResultsInterface $searchResults */
