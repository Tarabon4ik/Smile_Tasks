...
class Manifestation extends AbstractModel implements ManifestationInterface
{
    ...
    protected function _construct()
    {
        ...
        $this->setIdFieldName(ManifestationInterface::MANIFESTATION_ID);
    }
    ...
    {
        return $this->getData(ManifestationInterface::MANIFESTATION_ID);
    }
    ...
    {
        return $this->setData(ManifestationInterface::MANIFESTATION_ID, $id);
    }
