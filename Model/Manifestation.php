...
use Smile\Manifestation\Model\ResourceModel\Manifestation\Collection;
...
class Manifestation extends AbstractModel implements ManifestationInterface
{
     ...
     * @param ManifestationResourceModel $resource
    ...
    public function __construct(
        ...
        ManifestationResourceModel $resource,
    ...
    /**
     * Retrieve manifestation id by title
     *
     * @param string $title
     * @return int
     */
